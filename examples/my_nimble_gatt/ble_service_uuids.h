#ifndef BLE_SERVICE_UUIDS_H
#define BLE_SERVICE_UUIDS_H
...
struct ble_uuid_config_key_map chr_cfg_mapping[] = {
    {{&gatt_svr_chr_cfg_device_room_uuid}, {KEY_CONFIG_DEVICE_ROOM}},
    {{&gatt_svr_chr_cfg_device_id_uuid}, {KEY_CONFIG_DEVICE_ID}},
    {{&gatt_svr_chr_cfg_ota_host_uuid}, {KEY_CONFIG_OTA_HOST}},
    {{&gatt_svr_chr_cfg_ota_filename_uuid}, {KEY_CONFIG_OTA_FILENAME}},
    {{&gatt_svr_chr_cfg_ota_server_username_uuid}, {KEY_CONFIG_OTA_SERVER_USERNAME}},
    {{&gatt_svr_chr_cfg_ota_server_password_uuid}, {KEY_CONFIG_OTA_SERVER_PASSWORD}},
    {{&gatt_svr_chr_cfg_wifi_ssid_uuid}, {KEY_CONFIG_WIFI_SSID}},
    {{&gatt_svr_chr_cfg_wifi_password_uuid}, {KEY_CONFIG_WIFI_PASSWORD}},
    {{&gatt_svr_chr_cfg_mqtt_user_uuid}, {KEY_CONFIG_MQTT_USER}},
    {{&gatt_svr_chr_cfg_mqtt_password_uuid}, {KEY_CONFIG_MQTT_PASSWORD}},
    {{&gatt_svr_chr_cfg_mqtt_server_ip_uuid}, {KEY_CONFIG_MQTT_SERVER_IP}},
    {{&gatt_svr_chr_cfg_mqtt_server_port_uuid}, {KEY_CONFIG_MQTT_SERVER_PORT}},
    {{&gatt_svr_chr_cfg_sensor_poll_interval_ms_uuid}, {KEY_CONFIG_SENSOR_POLL_INTERVAL_MS}},
};

#endif /*BLE_SERVICE_UUIDS_H*/
